...
Kiểm tra cục bộ: node --test tests/hoc-tap.test.cjs tests/thu-tuan.test.cjs; build frontend: npm run build trong web. Không chạy setup/seed/trigger hoặc gửi dữ liệu thật để kiểm tra khi chưa có quyền vận hành.
