// Modern minimal stroke icons (Lucide-inspired)
...
const ICON_PATHS = {
  ...
  scale: (
    <>
      ...
      <path d="M7 7 4 14h6zM17 7l-3 7h6z"/>
      <path d="M5 7h14"/>
    </>
  ),
  globe: (
  ...
  scroll: (
    <>
      ...
      <path d="M21 17a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 0-2-2"/>
  ...
  flame: (
    <>
      <path d="M8.5 14.5A2.5 2.5 0 0 0 11 17c2.5 0 4-2 4-4 0-3-2-4-2-7 0 0-2 2-3 4-1.5 3-3 2-3 5 0 2 1.5 4 1.5 4z"/>
    </>
  ),
  trending: (
    <>
  ...
  users: (
    <>
      ...
      <path d="M21 21v-1a4 4 0 0 0-3-4"/>
    </>
  ),
  settings: (
    <>
...
function Icon({ name, size = 20, stroke = 1.75, color, style, className }) {
  ...
  if (!paths) return <span style={{ ...style, fontSize: size * 0.9 }}>?</span>;
  return (
    <svg
